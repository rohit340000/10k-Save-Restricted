    ...
    async with gagan.conversation(event.chat_id) as conv: 
        if not s:
            ...
            try:
                ...
                #print(e)
                logger.info(e)
                return await conv.send_message("Bhenchod! Jldi response De 👿")
            ...
            if int(fw.value) > 300:
                ...
                try:
                    ...
                    if countdown.text != count_down:
                        await countdown.edit(count_down, buttons=[[Button.url("Join Channel", url="https://t.me/galib_shayar")]])
        except Exception as e:
            #print(e)
            logger.info(e)
...
TEXT = "👋 Hi, This is 'Paid Restricted Content Saver' bot Made with ❤️ by __** @ll_BAD_BOI_ll **__."
